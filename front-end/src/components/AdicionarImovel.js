...
export default function AdicionarImovel(props) {

    const handleClose = () => {
        props.setOpenAdicionarImovel(false);
    };
    ...
    const handleSave = async () => {
        const novoImovel = {
            ...
            inquilino,
            email,
            aluguelBruto: Number(aluguelBruto), // Convertendo aluguelBruto para número
            vencimentoDia: Number(vencimentoDia), // Convertendo vencimentoDia para número
            moradores: Number(moradores), // Convertendo moradores para número
            desconto: Number(desconto), // Convertendo desconto para número
        ...
        await fetch('http://localhost:3001/cadastrarImovel', {
            ...
            .then((data) => {
                ...
                // Aqui você pode adicionar lógica para atualizar a lista de imóveis ou mostrar uma mensagem de sucesso
    ...
    return (
        <ThemeProvider theme={theme}>
            <Dialog open={props.openAdicionarImovel} onClose={handleClose}>
                <DialogTitle>Adicionar Imóvel</DialogTitle>
                <DialogContent>
                    <DialogContentText>
                        Para adicionar um novo imóvel, por favor preencha os campos abaixo.
                    </DialogContentText>
